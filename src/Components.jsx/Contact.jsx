              ...
              <div className="z-20 md:col-span-7 justify-center flex flex-col gap-5">
                <div className="space-y-3">
                  ...
                  <p className="text-white text-[15px] md:text-[18px] font-monster">
                    ...
                    It’s known <br className=" hidden md:flex " />
                    for its very long, sandy beachfront, stretching from Sea
                    Beach in the
                    <br className=" hidden md:flex " /> north to Kolatoli Beach
                    in the south. Aggameda Khyang monastery{" "}
                    <br className=" hidden md:flex " />
                    is home to bronze statues and centuries-old Buddhist
                    manuscripts.
                    <br className=" hidden md:flex " /> South of town, the
                    tropical rainforest of Himchari National Park has{" "}
                    <br className=" hidden md:flex " />
                    waterfalls and many birds. North, sea turtles breed on
